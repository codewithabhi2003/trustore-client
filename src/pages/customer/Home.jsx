...
import {
  Sparkles, MapPinned, ArrowRight, MapPin, BadgeCheck, Search,
  ShoppingBag, Store, ShieldCheck, Zap, Check,
} from 'lucide-react';
...
const steps = [
  { number: '01', icon: Search, title: 'Tell us what you need', desc: 'Type your shopping list naturally. No forms, filters, or endless catalog browsing.' },
  { number: '02', icon: Sparkles, title: 'AI understands your list', desc: 'Trustore turns your words into the products you actually need.' },
  { number: '03', icon: Store, title: 'We find the best local match', desc: 'Nearby verified stores are intelligently combined to cover your list.' },
  { number: '04', icon: ShoppingBag, title: 'One simple checkout', desc: 'Get everything you need through one seamless shopping experience.' },
];

const categories = [
  'Grocery', 'Dairy', 'Fruits & Veg', 'Bakery',
  'Beverages', 'Household', 'Snacks', 'Personal Care',
];

const sampleItems = [
  'Basmati rice', 'Toor dal', 'Milk', 'Bread', 'Bananas', 'Apples',
];
...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* HERO */}
      <section className="relative -mt-16 h-[100svh] min-h-[620px] max-h-[900px] overflow-hidden bg-base">
              ...
              >
                ...
                >
                  ...
                  <span className="block mt-1">
                    starts with a <span className="text-accent">sentence.</span>
                  </span>
                </motion.h1>
                ...
                <motion.p
                  ...
                  className="text-slate-700 dark:text-slate-300 text-sm sm:text-base lg:text-lg leading-relaxed mt-5 max-w-xl"
                >
                  Tell Trustore what you need in plain language. Our AI understands
                  your intent, finds the right products nearby, and connects you
                  with trusted local stores.
                </motion.p>
                  ...
                  <div className="bg-base border border-border rounded-xl p-4">
                    ...
                    <div className="flex gap-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[9px] text-slate-600 dark:text-slate-300 mt-0.5 mb-3">
                          ...
                          <div className="grid grid-cols-2 gap-1.5">
                            {sampleItems.map((item) => (
                              ...
                              >
                                ...
                                <span className="text-[8px] text-slate-700 dark:text-slate-300 truncate">
                                  {item}
                                </span>
                              </div>
                            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-7">
          <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-border">
            <div className="flex items-center gap-4 py-4 sm:py-2 sm:px-7 sm:first:pl-0">
              ...
              <div>
                <p className="text-sm font-bold text-text-primary">Search less.</p>
            ...
            <div className="flex items-center gap-4 py-4 sm:py-2 sm:px-7">
              ...
              <div>
                <p className="text-sm font-bold text-text-primary">Shop local.</p>
                <p className="text-xs text-slate-700 dark:text-slate-300 mt-0.5">
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-10">
            <div className="bg-card border border-border rounded-2xl shadow-sm p-5 sm:p-6 flex flex-col md:flex-row items-start md:items-center gap-4 justify-between">
              ...
              <div className="flex gap-2 w-full md:w-auto">
                ...
                <Link to="/addresses" className="flex-1 md:flex-none">
            ...
            <div className="relative grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-heading font-extrabold text-text-primary leading-tight">
                  ...
                  <span className="text-accent"> connected by AI.</span>
                </h2>

                <p className="text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed mt-4 max-w-xl">
                ...
                <div className="flex flex-wrap gap-3 mt-7">
                  ...
                  <Link
                    to="/stores"
                    className="inline-flex items-center gap-1.5 text-sm font-semibold text-slate-700 dark:text-slate-300 hover:text-accent px-2"
                  >
                    Meet local stores
                    <ArrowRight className="w-3.5 h-3.5" />
                  </Link>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  { icon: Sparkles, title: 'Natural language', desc: 'Shop the way you talk.' },
                  { icon: MapPinned, title: 'Local discovery', desc: 'Find stores around you.' },
                  { icon: BadgeCheck, title: 'Verified sellers', desc: 'Shop from trusted stores.' },
                  { icon: ShoppingBag, title: 'One shopping flow', desc: 'Build your order faster.' },
                ].map((item) => (
                  <div key={item.title} className="bg-card/70 border border-border rounded-xl p-4">
          ...
          <div className="flex flex-wrap gap-2.5">
            {categories.map((category) => (
              <Link
                ...
                className="group inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-card border border-border text-sm font-medium text-slate-700 dark:text-slate-300 hover:border-accent hover:text-accent hover:bg-accent-soft transition-all"
              >
                <span>{category}</span>
      ...
      <section className="relative border-t border-border bg-card overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-24 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-extrabold text-text-primary leading-tight">
            Your next shopping trip
            <span className="block text-accent">starts with a sentence.</span>
          </h2>

          <p className="text-black dark:text-white text-sm sm:text-base max-w-xl mx-auto mt-4 leading-relaxed">
